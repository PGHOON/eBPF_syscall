...
TRACE_SYSCALL(sys_exit_fstatfs, "sys_exit_fstatfs")
SEC("tp/syscalls/sys_exit_process_vm_writev")
TRACE_SYSCALL(sys_exit_process_vm_writev, "sys_exit_process_vm_writev")
SEC("tp/syscalls/sys_exit_fsync")
TRACE_SYSCALL(sys_exit_fsync, "sys_exit_fsync")
SEC("tp/syscalls/sys_exit_pselect6")
TRACE_SYSCALL(sys_exit_pselect6, "sys_exit_pselect6")
SEC("tp/syscalls/sys_exit_ftruncate")
TRACE_SYSCALL(sys_exit_ftruncate, "sys_exit_ftruncate")
SEC("tp/syscalls/sys_exit_ptrace")
TRACE_SYSCALL(sys_exit_ptrace, "sys_exit_ptrace")
SEC("tp/syscalls/sys_exit_futex")
TRACE_SYSCALL(sys_exit_futex, "sys_exit_futex")
SEC("tp/syscalls/sys_exit_pwrite64")
TRACE_SYSCALL(sys_exit_pwrite64, "sys_exit_pwrite64")
SEC("tp/syscalls/sys_exit_get_mempolicy")
TRACE_SYSCALL(sys_exit_get_mempolicy, "sys_exit_get_mempolicy")
SEC("tp/syscalls/sys_exit_pwritev")
TRACE_SYSCALL(sys_exit_pwritev, "sys_exit_pwritev")
SEC("tp/syscalls/sys_exit_get_robust_list")
TRACE_SYSCALL(sys_exit_get_robust_list, "sys_exit_get_robust_list")
SEC("tp/syscalls/sys_exit_pwritev2")
TRACE_SYSCALL(sys_exit_pwritev2, "sys_exit_pwritev2")
SEC("tp/syscalls/sys_exit_getcpu")
TRACE_SYSCALL(sys_exit_getcpu, "sys_exit_getcpu")
SEC("tp/syscalls/sys_exit_quotactl")
TRACE_SYSCALL(sys_exit_quotactl, "sys_exit_quotactl")
SEC("tp/syscalls/sys_exit_getcwd")
TRACE_SYSCALL(sys_exit_getcwd, "sys_exit_getcwd")
SEC("tp/syscalls/sys_exit_quotactl_fd")
TRACE_SYSCALL(sys_exit_quotactl_fd, "sys_exit_quotactl_fd")
SEC("tp/syscalls/sys_exit_getdents64")
TRACE_SYSCALL(sys_exit_getdents64, "sys_exit_getdents64")
SEC("tp/syscalls/sys_exit_read")
TRACE_SYSCALL(sys_exit_read, "sys_exit_read")
SEC("tp/syscalls/sys_exit_getegid")
TRACE_SYSCALL(sys_exit_getegid, "sys_exit_getegid")
SEC("tp/syscalls/sys_exit_readahead")
TRACE_SYSCALL(sys_exit_readahead, "sys_exit_readahead")
SEC("tp/syscalls/sys_exit_geteuid")
TRACE_SYSCALL(sys_exit_geteuid, "sys_exit_geteuid")
SEC("tp/syscalls/sys_exit_readlinkat")
TRACE_SYSCALL(sys_exit_readlinkat, "sys_exit_readlinkat")
SEC("tp/syscalls/sys_exit_getgid")
TRACE_SYSCALL(sys_exit_getgid, "sys_exit_getgid")
SEC("tp/syscalls/sys_exit_readv")
TRACE_SYSCALL(sys_exit_readv, "sys_exit_readv")
SEC("tp/syscalls/sys_exit_getgroups")
TRACE_SYSCALL(sys_exit_getgroups, "sys_exit_getgroups")
SEC("tp/syscalls/sys_exit_reboot")
TRACE_SYSCALL(sys_exit_reboot, "sys_exit_reboot")
SEC("tp/syscalls/sys_exit_getitimer")
TRACE_SYSCALL(sys_exit_getitimer, "sys_exit_getitimer")
SEC("tp/syscalls/sys_exit_recvfrom")
TRACE_SYSCALL(sys_exit_recvfrom, "sys_exit_recvfrom")
SEC("tp/syscalls/sys_exit_getpeername")
TRACE_SYSCALL(sys_exit_getpeername, "sys_exit_getpeername")
SEC("tp/syscalls/sys_exit_recvmmsg")
TRACE_SYSCALL(sys_exit_recvmmsg, "sys_exit_recvmmsg")
SEC("tp/syscalls/sys_exit_getpgid")
TRACE_SYSCALL(sys_exit_getpgid, "sys_exit_getpgid")
SEC("tp/syscalls/sys_exit_recvmsg")
TRACE_SYSCALL(sys_exit_recvmsg, "sys_exit_recvmsg")
SEC("tp/syscalls/sys_exit_getpid")
TRACE_SYSCALL(sys_exit_getpid, "sys_exit_getpid")
SEC("tp/syscalls/sys_exit_remap_file_pages")
TRACE_SYSCALL(sys_exit_remap_file_pages, "sys_exit_remap_file_pages")
SEC("tp/syscalls/sys_exit_getppid")
TRACE_SYSCALL(sys_exit_getppid, "sys_exit_getppid")
SEC("tp/syscalls/sys_exit_removexattr")
TRACE_SYSCALL(sys_exit_removexattr, "sys_exit_removexattr")
SEC("tp/syscalls/sys_exit_getpriority")
TRACE_SYSCALL(sys_exit_getpriority, "sys_exit_getpriority")
SEC("tp/syscalls/sys_exit_renameat")
TRACE_SYSCALL(sys_exit_renameat, "sys_exit_renameat")
SEC("tp/syscalls/sys_exit_getrandom")
TRACE_SYSCALL(sys_exit_getrandom, "sys_exit_getrandom")
SEC("tp/syscalls/sys_exit_renameat2")
TRACE_SYSCALL(sys_exit_renameat2, "sys_exit_renameat2")
SEC("tp/syscalls/sys_exit_getresgid")
TRACE_SYSCALL(sys_exit_getresgid, "sys_exit_getresgid")
SEC("tp/syscalls/sys_exit_request_key")
TRACE_SYSCALL(sys_exit_request_key, "sys_exit_request_key")
SEC("tp/syscalls/sys_exit_getresuid")
TRACE_SYSCALL(sys_exit_getresuid, "sys_exit_getresuid")
SEC("tp/syscalls/sys_exit_restart_syscall")
TRACE_SYSCALL(sys_exit_restart_syscall, "sys_exit_restart_syscall")
SEC("tp/syscalls/sys_exit_getrlimit")
TRACE_SYSCALL(sys_exit_getrlimit, "sys_exit_getrlimit")
SEC("tp/syscalls/sys_exit_rseq")
TRACE_SYSCALL(sys_exit_rseq, "sys_exit_rseq")
SEC("tp/syscalls/sys_exit_getrusage")
TRACE_SYSCALL(sys_exit_getrusage, "sys_exit_getrusage")
SEC("tp/syscalls/sys_exit_rt_sigaction")
TRACE_SYSCALL(sys_exit_rt_sigaction, "sys_exit_rt_sigaction")
SEC("tp/syscalls/sys_exit_getsid")
TRACE_SYSCALL(sys_exit_getsid, "sys_exit_getsid")
SEC("tp/syscalls/sys_exit_rt_sigpending")
TRACE_SYSCALL(sys_exit_rt_sigpending, "sys_exit_rt_sigpending")
SEC("tp/syscalls/sys_exit_getsockname")
TRACE_SYSCALL(sys_exit_getsockname, "sys_exit_getsockname")
SEC("tp/syscalls/sys_exit_rt_sigprocmask")
TRACE_SYSCALL(sys_exit_rt_sigprocmask, "sys_exit_rt_sigprocmask")
SEC("tp/syscalls/sys_exit_getsockopt")
TRACE_SYSCALL(sys_exit_getsockopt, "sys_exit_getsockopt")
SEC("tp/syscalls/sys_exit_rt_sigqueueinfo")
TRACE_SYSCALL(sys_exit_rt_sigqueueinfo, "sys_exit_rt_sigqueueinfo")
SEC("tp/syscalls/sys_exit_gettid")
TRACE_SYSCALL(sys_exit_gettid, "sys_exit_gettid")
SEC("tp/syscalls/sys_exit_rt_sigreturn")
TRACE_SYSCALL(sys_exit_rt_sigreturn, "sys_exit_rt_sigreturn")
SEC("tp/syscalls/sys_exit_gettimeofday")
TRACE_SYSCALL(sys_exit_gettimeofday, "sys_exit_gettimeofday")
SEC("tp/syscalls/sys_exit_rt_sigsuspend")
TRACE_SYSCALL(sys_exit_rt_sigsuspend, "sys_exit_rt_sigsuspend")
SEC("tp/syscalls/sys_exit_getuid")
TRACE_SYSCALL(sys_exit_getuid, "sys_exit_getuid")
SEC("tp/syscalls/sys_exit_rt_sigtimedwait")
TRACE_SYSCALL(sys_exit_rt_sigtimedwait, "sys_exit_rt_sigtimedwait")
SEC("tp/syscalls/sys_exit_getxattr")
TRACE_SYSCALL(sys_exit_getxattr, "sys_exit_getxattr")
SEC("tp/syscalls/sys_exit_rt_tgsigqueueinfo")
TRACE_SYSCALL(sys_exit_rt_tgsigqueueinfo, "sys_exit_rt_tgsigqueueinfo")
SEC("tp/syscalls/sys_exit_init_module")
TRACE_SYSCALL(sys_exit_init_module, "sys_exit_init_module")
SEC("tp/syscalls/sys_exit_sched_get_priority_max")
TRACE_SYSCALL(sys_exit_sched_get_priority_max, "sys_exit_sched_get_priority_max")
SEC("tp/syscalls/sys_exit_inotify_add_watch")
TRACE_SYSCALL(sys_exit_inotify_add_watch, "sys_exit_inotify_add_watch")
SEC("tp/syscalls/sys_exit_sched_get_priority_min")
TRACE_SYSCALL(sys_exit_sched_get_priority_min, "sys_exit_sched_get_priority_min")
SEC("tp/syscalls/sys_exit_inotify_init1")
TRACE_SYSCALL(sys_exit_inotify_init1, "sys_exit_inotify_init1")
SEC("tp/syscalls/sys_exit_sched_getaffinity")
TRACE_SYSCALL(sys_exit_sched_getaffinity, "sys_exit_sched_getaffinity")
SEC("tp/syscalls/sys_exit_inotify_rm_watch")
TRACE_SYSCALL(sys_exit_inotify_rm_watch, "sys_exit_inotify_rm_watch")
SEC("tp/syscalls/sys_exit_sched_getattr")
TRACE_SYSCALL(sys_exit_sched_getattr, "sys_exit_sched_getattr")
SEC("tp/syscalls/sys_exit_io_cancel")
TRACE_SYSCALL(sys_exit_io_cancel, "sys_exit_io_cancel")
SEC("tp/syscalls/sys_exit_sched_getparam")
TRACE_SYSCALL(sys_exit_sched_getparam, "sys_exit_sched_getparam")
SEC("tp/syscalls/sys_exit_io_destroy")
TRACE_SYSCALL(sys_exit_io_destroy, "sys_exit_io_destroy")
SEC("tp/syscalls/sys_exit_sched_getscheduler")
TRACE_SYSCALL(sys_exit_sched_getscheduler, "sys_exit_sched_getscheduler")
SEC("tp/syscalls/sys_exit_io_getevents")
TRACE_SYSCALL(sys_exit_io_getevents, "sys_exit_io_getevents")
SEC("tp/syscalls/sys_exit_sched_rr_get_interval")
TRACE_SYSCALL(sys_exit_sched_rr_get_interval, "sys_exit_sched_rr_get_interval")
SEC("tp/syscalls/sys_exit_io_pgetevents")
TRACE_SYSCALL(sys_exit_io_pgetevents, "sys_exit_io_pgetevents")
SEC("tp/syscalls/sys_exit_sched_setaffinity")
TRACE_SYSCALL(sys_exit_sched_setaffinity, "sys_exit_sched_setaffinity")
SEC("tp/syscalls/sys_exit_io_setup")
TRACE_SYSCALL(sys_exit_io_setup, "sys_exit_io_setup")
SEC("tp/syscalls/sys_exit_sched_setattr")
TRACE_SYSCALL(sys_exit_sched_setattr, "sys_exit_sched_setattr")
SEC("tp/syscalls/sys_exit_io_submit")
TRACE_SYSCALL(sys_exit_io_submit, "sys_exit_io_submit")
SEC("tp/syscalls/sys_exit_sched_setparam")
TRACE_SYSCALL(sys_exit_sched_setparam, "sys_exit_sched_setparam")
SEC("tp/syscalls/sys_exit_io_uring_enter")
TRACE_SYSCALL(sys_exit_io_uring_enter, "sys_exit_io_uring_enter")
SEC("tp/syscalls/sys_exit_sched_setscheduler")
TRACE_SYSCALL(sys_exit_sched_setscheduler, "sys_exit_sched_setscheduler")
SEC("tp/syscalls/sys_exit_io_uring_register")
TRACE_SYSCALL(sys_exit_io_uring_register, "sys_exit_io_uring_register")
SEC("tp/syscalls/sys_exit_sched_yield")
TRACE_SYSCALL(sys_exit_sched_yield, "sys_exit_sched_yield")
SEC("tp/syscalls/sys_exit_io_uring_setup")
TRACE_SYSCALL(sys_exit_io_uring_setup, "sys_exit_io_uring_setup")
SEC("tp/syscalls/sys_exit_seccomp")
TRACE_SYSCALL(sys_exit_seccomp, "sys_exit_seccomp")
SEC("tp/syscalls/sys_exit_ioctl")
TRACE_SYSCALL(sys_exit_ioctl, "sys_exit_ioctl")
SEC("tp/syscalls/sys_exit_semctl")
TRACE_SYSCALL(sys_exit_semctl, "sys_exit_semctl")
SEC("tp/syscalls/sys_exit_ioprio_get")
TRACE_SYSCALL(sys_exit_ioprio_get, "sys_exit_ioprio_get")
SEC("tp/syscalls/sys_exit_semget")
TRACE_SYSCALL(sys_exit_semget, "sys_exit_semget")
SEC("tp/syscalls/sys_exit_ioprio_set")
TRACE_SYSCALL(sys_exit_ioprio_set, "sys_exit_ioprio_set")
SEC("tp/syscalls/sys_exit_semop")
TRACE_SYSCALL(sys_exit_semop, "sys_exit_semop")
SEC("tp/syscalls/sys_exit_kcmp")
TRACE_SYSCALL(sys_exit_kcmp, "sys_exit_kcmp")
SEC("tp/syscalls/sys_exit_semtimedop")
TRACE_SYSCALL(sys_exit_semtimedop, "sys_exit_semtimedop")
SEC("tp/syscalls/sys_exit_kexec_file_load")
TRACE_SYSCALL(sys_exit_kexec_file_load, "sys_exit_kexec_file_load")
SEC("tp/syscalls/sys_exit_sendfile64")
TRACE_SYSCALL(sys_exit_sendfile64, "sys_exit_sendfile64")
SEC("tp/syscalls/sys_exit_kexec_load")
TRACE_SYSCALL(sys_exit_kexec_load, "sys_exit_kexec_load")
SEC("tp/syscalls/sys_exit_sendmmsg")
TRACE_SYSCALL(sys_exit_sendmmsg, "sys_exit_sendmmsg")
SEC("tp/syscalls/sys_exit_keyctl")
TRACE_SYSCALL(sys_exit_keyctl, "sys_exit_keyctl")
SEC("tp/syscalls/sys_exit_sendmsg")
TRACE_SYSCALL(sys_exit_sendmsg, "sys_exit_sendmsg")
SEC("tp/syscalls/sys_exit_kill")
TRACE_SYSCALL(sys_exit_kill, "sys_exit_kill")
SEC("tp/syscalls/sys_exit_sendto")
TRACE_SYSCALL(sys_exit_sendto, "sys_exit_sendto")
SEC("tp/syscalls/sys_exit_landlock_add_rule")
TRACE_SYSCALL(sys_exit_landlock_add_rule, "sys_exit_landlock_add_rule")
SEC("tp/syscalls/sys_exit_set_mempolicy")
TRACE_SYSCALL(sys_exit_set_mempolicy, "sys_exit_set_mempolicy")
SEC("tp/syscalls/sys_exit_landlock_create_ruleset")
TRACE_SYSCALL(sys_exit_landlock_create_ruleset, "sys_exit_landlock_create_ruleset")
SEC("tp/syscalls/sys_exit_set_robust_list")
TRACE_SYSCALL(sys_exit_set_robust_list, "sys_exit_set_robust_list")
SEC("tp/syscalls/sys_exit_landlock_restrict_self")
TRACE_SYSCALL(sys_exit_landlock_restrict_self, "sys_exit_landlock_restrict_self")
SEC("tp/syscalls/sys_exit_set_tid_address")
TRACE_SYSCALL(sys_exit_set_tid_address, "sys_exit_set_tid_address")
SEC("tp/syscalls/sys_exit_lgetxattr")
TRACE_SYSCALL(sys_exit_lgetxattr, "sys_exit_lgetxattr")
SEC("tp/syscalls/sys_exit_setdomainname")
TRACE_SYSCALL(sys_exit_setdomainname, "sys_exit_setdomainname")
SEC("tp/syscalls/sys_exit_linkat")
TRACE_SYSCALL(sys_exit_linkat, "sys_exit_linkat")
SEC("tp/syscalls/sys_exit_setfsgid")
TRACE_SYSCALL(sys_exit_setfsgid, "sys_exit_setfsgid")
SEC("tp/syscalls/sys_exit_listen")
TRACE_SYSCALL(sys_exit_listen, "sys_exit_listen")
SEC("tp/syscalls/sys_exit_setfsuid")
TRACE_SYSCALL(sys_exit_setfsuid, "sys_exit_setfsuid")
SEC("tp/syscalls/sys_exit_listxattr")
TRACE_SYSCALL(sys_exit_listxattr, "sys_exit_listxattr")
SEC("tp/syscalls/sys_exit_setgid")
TRACE_SYSCALL(sys_exit_setgid, "sys_exit_setgid")
SEC("tp/syscalls/sys_exit_llistxattr")
TRACE_SYSCALL(sys_exit_llistxattr, "sys_exit_llistxattr")
SEC("tp/syscalls/sys_exit_setgroups")
TRACE_SYSCALL(sys_exit_setgroups, "sys_exit_setgroups")
SEC("tp/syscalls/sys_exit_lremovexattr")
TRACE_SYSCALL(sys_exit_lremovexattr, "sys_exit_lremovexattr")
SEC("tp/syscalls/sys_exit_sethostname")
TRACE_SYSCALL(sys_exit_sethostname, "sys_exit_sethostname")
SEC("tp/syscalls/sys_exit_accept")
TRACE_SYSCALL(sys_exit_accept, "sys_exit_accept")
SEC("tp/syscalls/sys_exit_lseek")
TRACE_SYSCALL(sys_exit_lseek, "sys_exit_lseek")
SEC("tp/syscalls/sys_exit_setitimer")
TRACE_SYSCALL(sys_exit_setitimer, "sys_exit_setitimer")
SEC("tp/syscalls/sys_exit_accept4")
TRACE_SYSCALL(sys_exit_accept4, "sys_exit_accept4")
SEC("tp/syscalls/sys_exit_lsetxattr")
TRACE_SYSCALL(sys_exit_lsetxattr, "sys_exit_lsetxattr")
SEC("tp/syscalls/sys_exit_setns")
TRACE_SYSCALL(sys_exit_setns, "sys_exit_setns")
SEC("tp/syscalls/sys_exit_acct")
TRACE_SYSCALL(sys_exit_acct, "sys_exit_acct")
SEC("tp/syscalls/sys_exit_madvise")
TRACE_SYSCALL(sys_exit_madvise, "sys_exit_madvise")
SEC("tp/syscalls/sys_exit_setpgid")
TRACE_SYSCALL(sys_exit_setpgid, "sys_exit_setpgid")
SEC("tp/syscalls/sys_exit_add_key")
TRACE_SYSCALL(sys_exit_add_key, "sys_exit_add_key")
SEC("tp/syscalls/sys_exit_mbind")
TRACE_SYSCALL(sys_exit_mbind, "sys_exit_mbind")
SEC("tp/syscalls/sys_exit_setpriority")
TRACE_SYSCALL(sys_exit_setpriority, "sys_exit_setpriority")
SEC("tp/syscalls/sys_exit_adjtimex")
TRACE_SYSCALL(sys_exit_adjtimex, "sys_exit_adjtimex")
SEC("tp/syscalls/sys_exit_membarrier")
TRACE_SYSCALL(sys_exit_membarrier, "sys_exit_membarrier")
SEC("tp/syscalls/sys_exit_setregid")
TRACE_SYSCALL(sys_exit_setregid, "sys_exit_setregid")
SEC("tp/syscalls/sys_exit_personality")
TRACE_SYSCALL(sys_exit_personality, "sys_exit_personality")
SEC("tp/syscalls/sys_exit_memfd_create")
TRACE_SYSCALL(sys_exit_memfd_create, "sys_exit_memfd_create")
SEC("tp/syscalls/sys_exit_setresgid")
TRACE_SYSCALL(sys_exit_setresgid, "sys_exit_setresgid")
SEC("tp/syscalls/sys_exit_bind")
TRACE_SYSCALL(sys_exit_bind, "sys_exit_bind")
SEC("tp/syscalls/sys_exit_memfd_secret")
TRACE_SYSCALL(sys_exit_memfd_secret, "sys_exit_memfd_secret")
SEC("tp/syscalls/sys_exit_setresuid")
TRACE_SYSCALL(sys_exit_setresuid, "sys_exit_setresuid")
SEC("tp/syscalls/sys_exit_bpf")
TRACE_SYSCALL(sys_exit_bpf, "sys_exit_bpf")
SEC("tp/syscalls/sys_exit_migrate_pages")
TRACE_SYSCALL(sys_exit_migrate_pages, "sys_exit_migrate_pages")
SEC("tp/syscalls/sys_exit_setreuid")
TRACE_SYSCALL(sys_exit_setreuid, "sys_exit_setreuid")
SEC("tp/syscalls/sys_exit_brk")
TRACE_SYSCALL(sys_exit_brk, "sys_exit_brk")
SEC("tp/syscalls/sys_exit_mincore")
TRACE_SYSCALL(sys_exit_mincore, "sys_exit_mincore")
SEC("tp/syscalls/sys_exit_setrlimit")
TRACE_SYSCALL(sys_exit_setrlimit, "sys_exit_setrlimit")
SEC("tp/syscalls/sys_exit_capget")
TRACE_SYSCALL(sys_exit_capget, "sys_exit_capget")
SEC("tp/syscalls/sys_exit_mkdirat")
TRACE_SYSCALL(sys_exit_mkdirat, "sys_exit_mkdirat")
SEC("tp/syscalls/sys_exit_setsid")
TRACE_SYSCALL(sys_exit_setsid, "sys_exit_setsid")
SEC("tp/syscalls/sys_exit_capset")
TRACE_SYSCALL(sys_exit_capset, "sys_exit_capset")
SEC("tp/syscalls/sys_exit_mknodat")
TRACE_SYSCALL(sys_exit_mknodat, "sys_exit_mknodat")
SEC("tp/syscalls/sys_exit_setsockopt")
TRACE_SYSCALL(sys_exit_setsockopt, "sys_exit_setsockopt")
SEC("tp/syscalls/sys_exit_chdir")
TRACE_SYSCALL(sys_exit_chdir, "sys_exit_chdir")
SEC("tp/syscalls/sys_exit_mlock")
TRACE_SYSCALL(sys_exit_mlock, "sys_exit_mlock")
SEC("tp/syscalls/sys_exit_settimeofday")
TRACE_SYSCALL(sys_exit_settimeofday, "sys_exit_settimeofday")
SEC("tp/syscalls/sys_exit_chroot")
TRACE_SYSCALL(sys_exit_chroot, "sys_exit_chroot")
SEC("tp/syscalls/sys_exit_mlock2")
TRACE_SYSCALL(sys_exit_mlock2, "sys_exit_mlock2")
SEC("tp/syscalls/sys_exit_setuid")
TRACE_SYSCALL(sys_exit_setuid, "sys_exit_setuid")
SEC("tp/syscalls/sys_exit_clock_adjtime")
TRACE_SYSCALL(sys_exit_clock_adjtime, "sys_exit_clock_adjtime")
SEC("tp/syscalls/sys_exit_mlockall")
TRACE_SYSCALL(sys_exit_mlockall, "sys_exit_mlockall")
SEC("tp/syscalls/sys_exit_setxattr")
TRACE_SYSCALL(sys_exit_setxattr, "sys_exit_setxattr")
SEC("tp/syscalls/sys_exit_clock_getres")
TRACE_SYSCALL(sys_exit_clock_getres, "sys_exit_clock_getres")
SEC("tp/syscalls/sys_exit_mmap")
TRACE_SYSCALL(sys_exit_mmap, "sys_exit_mmap")
SEC("tp/syscalls/sys_exit_shmat")
TRACE_SYSCALL(sys_exit_shmat, "sys_exit_shmat")
SEC("tp/syscalls/sys_exit_clock_gettime")
TRACE_SYSCALL(sys_exit_clock_gettime, "sys_exit_clock_gettime")
SEC("tp/syscalls/sys_exit_mount")
TRACE_SYSCALL(sys_exit_mount, "sys_exit_mount")
SEC("tp/syscalls/sys_exit_shmctl")
TRACE_SYSCALL(sys_exit_shmctl, "sys_exit_shmctl")
SEC("tp/syscalls/sys_exit_clock_nanosleep")
TRACE_SYSCALL(sys_exit_clock_nanosleep, "sys_exit_clock_nanosleep")
SEC("tp/syscalls/sys_exit_mount_setattr")
TRACE_SYSCALL(sys_exit_mount_setattr, "sys_exit_mount_setattr")
SEC("tp/syscalls/sys_exit_shmdt")
TRACE_SYSCALL(sys_exit_shmdt, "sys_exit_shmdt")
SEC("tp/syscalls/sys_exit_clock_settime")
TRACE_SYSCALL(sys_exit_clock_settime, "sys_exit_clock_settime")
SEC("tp/syscalls/sys_exit_move_mount")
TRACE_SYSCALL(sys_exit_move_mount, "sys_exit_move_mount")
SEC("tp/syscalls/sys_exit_shmget")
TRACE_SYSCALL(sys_exit_shmget, "sys_exit_shmget")
SEC("tp/syscalls/sys_exit_clone")
TRACE_SYSCALL(sys_exit_clone, "sys_exit_clone")
SEC("tp/syscalls/sys_exit_move_pages")
TRACE_SYSCALL(sys_exit_move_pages, "sys_exit_move_pages")
SEC("tp/syscalls/sys_exit_shutdown")
TRACE_SYSCALL(sys_exit_shutdown, "sys_exit_shutdown")
SEC("tp/syscalls/sys_exit_clone3")
TRACE_SYSCALL(sys_exit_clone3, "sys_exit_clone3")
SEC("tp/syscalls/sys_exit_mprotect")
TRACE_SYSCALL(sys_exit_mprotect, "sys_exit_mprotect")
SEC("tp/syscalls/sys_exit_sigaltstack")
TRACE_SYSCALL(sys_exit_sigaltstack, "sys_exit_sigaltstack")
SEC("tp/syscalls/sys_exit_close")
TRACE_SYSCALL(sys_exit_close, "sys_exit_close")
SEC("tp/syscalls/sys_exit_mq_getsetattr")
TRACE_SYSCALL(sys_exit_mq_getsetattr, "sys_exit_mq_getsetattr")
SEC("tp/syscalls/sys_exit_signalfd4")
TRACE_SYSCALL(sys_exit_signalfd4, "sys_exit_signalfd4")
SEC("tp/syscalls/sys_exit_close_range")
TRACE_SYSCALL(sys_exit_close_range, "sys_exit_close_range")
SEC("tp/syscalls/sys_exit_mq_notify")
TRACE_SYSCALL(sys_exit_mq_notify, "sys_exit_mq_notify")
SEC("tp/syscalls/sys_exit_socket")
TRACE_SYSCALL(sys_exit_socket, "sys_exit_socket")
SEC("tp/syscalls/sys_exit_connect")
TRACE_SYSCALL(sys_exit_connect, "sys_exit_connect")
SEC("tp/syscalls/sys_exit_mq_open")
TRACE_SYSCALL(sys_exit_mq_open, "sys_exit_mq_open")
SEC("tp/syscalls/sys_exit_socketpair")
TRACE_SYSCALL(sys_exit_socketpair, "sys_exit_socketpair")
SEC("tp/syscalls/sys_exit_copy_file_range")
TRACE_SYSCALL(sys_exit_copy_file_range, "sys_exit_copy_file_range")
SEC("tp/syscalls/sys_exit_mq_timedreceive")
TRACE_SYSCALL(sys_exit_mq_timedreceive, "sys_exit_mq_timedreceive")
SEC("tp/syscalls/sys_exit_splice")
TRACE_SYSCALL(sys_exit_splice, "sys_exit_splice")
SEC("tp/syscalls/sys_exit_delete_module")
TRACE_SYSCALL(sys_exit_delete_module, "sys_exit_delete_module")
SEC("tp/syscalls/sys_exit_mq_timedsend")
TRACE_SYSCALL(sys_exit_mq_timedsend, "sys_exit_mq_timedsend")
SEC("tp/syscalls/sys_exit_statfs")
TRACE_SYSCALL(sys_exit_statfs, "sys_exit_statfs")
SEC("tp/syscalls/sys_exit_dup")
TRACE_SYSCALL(sys_exit_dup, "sys_exit_dup")
SEC("tp/syscalls/sys_exit_mq_unlink")
TRACE_SYSCALL(sys_exit_mq_unlink, "sys_exit_mq_unlink")
SEC("tp/syscalls/sys_exit_statx")
TRACE_SYSCALL(sys_exit_statx, "sys_exit_statx")
SEC("tp/syscalls/sys_exit_dup3")
TRACE_SYSCALL(sys_exit_dup3, "sys_exit_dup3")
SEC("tp/syscalls/sys_exit_mremap")
TRACE_SYSCALL(sys_exit_mremap, "sys_exit_mremap")
SEC("tp/syscalls/sys_exit_swapoff")
TRACE_SYSCALL(sys_exit_swapoff, "sys_exit_swapoff")
SEC("tp/syscalls/sys_exit_epoll_create1")
TRACE_SYSCALL(sys_exit_epoll_create1, "sys_exit_epoll_create1")
SEC("tp/syscalls/sys_exit_msgctl")
TRACE_SYSCALL(sys_exit_msgctl, "sys_exit_msgctl")
SEC("tp/syscalls/sys_exit_swapon")
TRACE_SYSCALL(sys_exit_swapon, "sys_exit_swapon")
SEC("tp/syscalls/sys_exit_epoll_ctl")
TRACE_SYSCALL(sys_exit_epoll_ctl, "sys_exit_epoll_ctl")
SEC("tp/syscalls/sys_exit_msgget")
TRACE_SYSCALL(sys_exit_msgget, "sys_exit_msgget")
SEC("tp/syscalls/sys_exit_symlinkat")
TRACE_SYSCALL(sys_exit_symlinkat, "sys_exit_symlinkat")
SEC("tp/syscalls/sys_exit_epoll_pwait")
TRACE_SYSCALL(sys_exit_epoll_pwait, "sys_exit_epoll_pwait")
SEC("tp/syscalls/sys_exit_msgrcv")
TRACE_SYSCALL(sys_exit_msgrcv, "sys_exit_msgrcv")
SEC("tp/syscalls/sys_exit_sync")
TRACE_SYSCALL(sys_exit_sync, "sys_exit_sync")
SEC("tp/syscalls/sys_exit_epoll_pwait2")
TRACE_SYSCALL(sys_exit_epoll_pwait2, "sys_exit_epoll_pwait2")
SEC("tp/syscalls/sys_exit_msgsnd")
TRACE_SYSCALL(sys_exit_msgsnd, "sys_exit_msgsnd")
SEC("tp/syscalls/sys_exit_sync_file_range")
TRACE_SYSCALL(sys_exit_sync_file_range, "sys_exit_sync_file_range")
SEC("tp/syscalls/sys_exit_eventfd2")
TRACE_SYSCALL(sys_exit_eventfd2, "sys_exit_eventfd2")
SEC("tp/syscalls/sys_exit_msync")
TRACE_SYSCALL(sys_exit_msync, "sys_exit_msync")
SEC("tp/syscalls/sys_exit_syncfs")
TRACE_SYSCALL(sys_exit_syncfs, "sys_exit_syncfs")
SEC("tp/syscalls/sys_exit_execve")
TRACE_SYSCALL(sys_exit_execve, "sys_exit_execve")
SEC("tp/syscalls/sys_exit_munlock")
TRACE_SYSCALL(sys_exit_munlock, "sys_exit_munlock")
SEC("tp/syscalls/sys_exit_sysinfo")
TRACE_SYSCALL(sys_exit_sysinfo, "sys_exit_sysinfo")
SEC("tp/syscalls/sys_exit_execveat")
TRACE_SYSCALL(sys_exit_execveat, "sys_exit_execveat")
SEC("tp/syscalls/sys_exit_munlockall")
TRACE_SYSCALL(sys_exit_munlockall, "sys_exit_munlockall")
SEC("tp/syscalls/sys_exit_syslog")
TRACE_SYSCALL(sys_exit_syslog, "sys_exit_syslog")
SEC("tp/syscalls/sys_exit_exit")
TRACE_SYSCALL(sys_exit_exit, "sys_exit_exit")
SEC("tp/syscalls/sys_exit_munmap")
TRACE_SYSCALL(sys_exit_munmap, "sys_exit_munmap")
SEC("tp/syscalls/sys_exit_tee")
TRACE_SYSCALL(sys_exit_tee, "sys_exit_tee")
SEC("tp/syscalls/sys_exit_exit_group")
TRACE_SYSCALL(sys_exit_exit_group, "sys_exit_exit_group")
SEC("tp/syscalls/sys_exit_name_to_handle_at")
TRACE_SYSCALL(sys_exit_name_to_handle_at, "sys_exit_name_to_handle_at")
SEC("tp/syscalls/sys_exit_tgkill")
TRACE_SYSCALL(sys_exit_tgkill, "sys_exit_tgkill")
SEC("tp/syscalls/sys_exit_faccessat")
TRACE_SYSCALL(sys_exit_faccessat, "sys_exit_faccessat")
SEC("tp/syscalls/sys_exit_nanosleep")
TRACE_SYSCALL(sys_exit_nanosleep, "sys_exit_nanosleep")
SEC("tp/syscalls/sys_exit_timer_create")
TRACE_SYSCALL(sys_exit_timer_create, "sys_exit_timer_create")
SEC("tp/syscalls/sys_exit_faccessat2")
TRACE_SYSCALL(sys_exit_faccessat2, "sys_exit_faccessat2")
SEC("tp/syscalls/sys_exit_newfstat")
TRACE_SYSCALL(sys_exit_newfstat, "sys_exit_newfstat")
SEC("tp/syscalls/sys_exit_timer_delete")
TRACE_SYSCALL(sys_exit_timer_delete, "sys_exit_timer_delete")
SEC("tp/syscalls/sys_exit_fadvise64")
TRACE_SYSCALL(sys_exit_fadvise64, "sys_exit_fadvise64")
SEC("tp/syscalls/sys_exit_newfstatat")
TRACE_SYSCALL(sys_exit_newfstatat, "sys_exit_newfstatat")
SEC("tp/syscalls/sys_exit_timer_getoverrun")
TRACE_SYSCALL(sys_exit_timer_getoverrun, "sys_exit_timer_getoverrun")
SEC("tp/syscalls/sys_exit_fallocate")
TRACE_SYSCALL(sys_exit_fallocate, "sys_exit_fallocate")
SEC("tp/syscalls/sys_exit_newuname")
TRACE_SYSCALL(sys_exit_newuname, "sys_exit_newuname")
SEC("tp/syscalls/sys_exit_timer_gettime")
TRACE_SYSCALL(sys_exit_timer_gettime, "sys_exit_timer_gettime")
SEC("tp/syscalls/sys_exit_fanotify_init")
TRACE_SYSCALL(sys_exit_fanotify_init, "sys_exit_fanotify_init")
SEC("tp/syscalls/sys_exit_open_by_handle_at")
TRACE_SYSCALL(sys_exit_open_by_handle_at, "sys_exit_open_by_handle_at")
SEC("tp/syscalls/sys_exit_timer_settime")
TRACE_SYSCALL(sys_exit_timer_settime, "sys_exit_timer_settime")
SEC("tp/syscalls/sys_exit_fanotify_mark")
TRACE_SYSCALL(sys_exit_fanotify_mark, "sys_exit_fanotify_mark")
SEC("tp/syscalls/sys_exit_open_tree")
TRACE_SYSCALL(sys_exit_open_tree, "sys_exit_open_tree")
SEC("tp/syscalls/sys_exit_timerfd_create")
TRACE_SYSCALL(sys_exit_timerfd_create, "sys_exit_timerfd_create")
SEC("tp/syscalls/sys_exit_fchdir")
TRACE_SYSCALL(sys_exit_fchdir, "sys_exit_fchdir")
SEC("tp/syscalls/sys_exit_openat")
TRACE_SYSCALL(sys_exit_openat, "sys_exit_openat")
SEC("tp/syscalls/sys_exit_timerfd_gettime")
TRACE_SYSCALL(sys_exit_timerfd_gettime, "sys_exit_timerfd_gettime")
SEC("tp/syscalls/sys_exit_fchmod")
TRACE_SYSCALL(sys_exit_fchmod, "sys_exit_fchmod")
SEC("tp/syscalls/sys_exit_openat2")
TRACE_SYSCALL(sys_exit_openat2, "sys_exit_openat2")
SEC("tp/syscalls/sys_exit_timerfd_settime")
TRACE_SYSCALL(sys_exit_timerfd_settime, "sys_exit_timerfd_settime")
SEC("tp/syscalls/sys_exit_fchmodat")
TRACE_SYSCALL(sys_exit_fchmodat, "sys_exit_fchmodat")
SEC("tp/syscalls/sys_exit_perf_event_open")
TRACE_SYSCALL(sys_exit_perf_event_open, "sys_exit_perf_event_open")
SEC("tp/syscalls/sys_exit_times")
TRACE_SYSCALL(sys_exit_times, "sys_exit_times")
SEC("tp/syscalls/sys_exit_fchown")
TRACE_SYSCALL(sys_exit_fchown, "sys_exit_fchown")
SEC("tp/syscalls/sys_exit_pidfd_getfd")
TRACE_SYSCALL(sys_exit_pidfd_getfd, "sys_exit_pidfd_getfd")
SEC("tp/syscalls/sys_exit_tkill")
TRACE_SYSCALL(sys_exit_tkill, "sys_exit_tkill")
SEC("tp/syscalls/sys_exit_fchownat")
TRACE_SYSCALL(sys_exit_fchownat, "sys_exit_fchownat")
SEC("tp/syscalls/sys_exit_pidfd_open")
TRACE_SYSCALL(sys_exit_pidfd_open, "sys_exit_pidfd_open")
SEC("tp/syscalls/sys_exit_truncate")
TRACE_SYSCALL(sys_exit_truncate, "sys_exit_truncate")
SEC("tp/syscalls/sys_exit_fcntl")
TRACE_SYSCALL(sys_exit_fcntl, "sys_exit_fcntl")
SEC("tp/syscalls/sys_exit_pidfd_send_signal")
TRACE_SYSCALL(sys_exit_pidfd_send_signal, "sys_exit_pidfd_send_signal")
SEC("tp/syscalls/sys_exit_umask")
TRACE_SYSCALL(sys_exit_umask, "sys_exit_umask")
SEC("tp/syscalls/sys_exit_fdatasync")
TRACE_SYSCALL(sys_exit_fdatasync, "sys_exit_fdatasync")
SEC("tp/syscalls/sys_exit_pipe2")
TRACE_SYSCALL(sys_exit_pipe2, "sys_exit_pipe2")
SEC("tp/syscalls/sys_exit_umount")
TRACE_SYSCALL(sys_exit_umount, "sys_exit_umount")
SEC("tp/syscalls/sys_exit_fgetxattr")
TRACE_SYSCALL(sys_exit_fgetxattr, "sys_exit_fgetxattr")
SEC("tp/syscalls/sys_exit_pivot_root")
TRACE_SYSCALL(sys_exit_pivot_root, "sys_exit_pivot_root")
SEC("tp/syscalls/sys_exit_unlinkat")
TRACE_SYSCALL(sys_exit_unlinkat, "sys_exit_unlinkat")
SEC("tp/syscalls/sys_exit_finit_module")
TRACE_SYSCALL(sys_exit_finit_module, "sys_exit_finit_module")
SEC("tp/syscalls/sys_exit_ppoll")
TRACE_SYSCALL(sys_exit_ppoll, "sys_exit_ppoll")
SEC("tp/syscalls/sys_exit_unshare")
TRACE_SYSCALL(sys_exit_unshare, "sys_exit_unshare")
SEC("tp/syscalls/sys_exit_flistxattr")
TRACE_SYSCALL(sys_exit_flistxattr, "sys_exit_flistxattr")
SEC("tp/syscalls/sys_exit_prctl")
TRACE_SYSCALL(sys_exit_prctl, "sys_exit_prctl")
SEC("tp/syscalls/sys_exit_userfaultfd")
TRACE_SYSCALL(sys_exit_userfaultfd, "sys_exit_userfaultfd")
SEC("tp/syscalls/sys_exit_flock")
TRACE_SYSCALL(sys_exit_flock, "sys_exit_flock")
SEC("tp/syscalls/sys_exit_pread64")
TRACE_SYSCALL(sys_exit_pread64, "sys_exit_pread64")
SEC("tp/syscalls/sys_exit_utimensat")
TRACE_SYSCALL(sys_exit_utimensat, "sys_exit_utimensat")
SEC("tp/syscalls/sys_exit_fremovexattr")
TRACE_SYSCALL(sys_exit_fremovexattr, "sys_exit_fremovexattr")
SEC("tp/syscalls/sys_exit_preadv")
TRACE_SYSCALL(sys_exit_preadv, "sys_exit_preadv")
SEC("tp/syscalls/sys_exit_vhangup")
TRACE_SYSCALL(sys_exit_vhangup, "sys_exit_vhangup")
SEC("tp/syscalls/sys_exit_fsconfig")
TRACE_SYSCALL(sys_exit_fsconfig, "sys_exit_fsconfig")
SEC("tp/syscalls/sys_exit_preadv2")
TRACE_SYSCALL(sys_exit_preadv2, "sys_exit_preadv2")
SEC("tp/syscalls/sys_exit_vmsplice")
TRACE_SYSCALL(sys_exit_vmsplice, "sys_exit_vmsplice")
SEC("tp/syscalls/sys_exit_fsetxattr")
TRACE_SYSCALL(sys_exit_fsetxattr, "sys_exit_fsetxattr")
SEC("tp/syscalls/sys_exit_prlimit64")
TRACE_SYSCALL(sys_exit_prlimit64, "sys_exit_prlimit64")
SEC("tp/syscalls/sys_exit_wait4")
TRACE_SYSCALL(sys_exit_wait4, "sys_exit_wait4")
SEC("tp/syscalls/sys_exit_fsmount")
TRACE_SYSCALL(sys_exit_fsmount, "sys_exit_fsmount")
SEC("tp/syscalls/sys_exit_process_madvise")
TRACE_SYSCALL(sys_exit_process_madvise, "sys_exit_process_madvise")
SEC("tp/syscalls/sys_exit_waitid")
TRACE_SYSCALL(sys_exit_waitid, "sys_exit_waitid")
SEC("tp/syscalls/sys_exit_fsopen")
TRACE_SYSCALL(sys_exit_fsopen, "sys_exit_fsopen")
SEC("tp/syscalls/sys_exit_process_mrelease")
TRACE_SYSCALL(sys_exit_process_mrelease, "sys_exit_process_mrelease")
SEC("tp/syscalls/sys_exit_write")
TRACE_SYSCALL(sys_exit_write, "sys_exit_write")
SEC("tp/syscalls/sys_exit_fspick")
TRACE_SYSCALL(sys_exit_fspick, "sys_exit_fspick")
SEC("tp/syscalls/sys_exit_process_vm_readv")
TRACE_SYSCALL(sys_exit_process_vm_readv, "sys_exit_process_vm_readv")
SEC("tp/syscalls/sys_exit_writev")
TRACE_SYSCALL(sys_exit_writev, "sys_exit_writev")
*/
